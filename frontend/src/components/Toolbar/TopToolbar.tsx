    ...
    return (
        <div className="top-toolbar">
            ...
            <div className="action-buttons">
                <button className="json-btn" onClick={onImportJSON} title="Импорт JSON">
                    <SvgIcon path={<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M7 10l5 5 5-5M12 15V3"/>} />
                </button>
                <button className="json-btn" onClick={onExportJSON} title="Экспорт JSON">
                    <SvgIcon path={<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4M17 8l-5-5-5 5M12 3v12"/>} />
                </button>
                <button className="export-btn" onClick={onExportPDF} title="Экспорт в PDF">
                    PDF
                </button>
